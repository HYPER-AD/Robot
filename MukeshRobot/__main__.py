...
PM_START_TEXT = """
*ʜᴇʏ* {}, [🥀 ](https://te.legra.ph/file/1ddb6b196f2b303b2e0b6.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="✰ ᴄʟɪᴄᴋ ᴛᴏ ᴍᴀᴋᴇ ᴍᴇ ʏᴏᴜʀ ɢғ ✰",
            url=f"https://t.me/{dispatcher.bot.username}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="✰ ʜᴇʟᴘs & ᴄᴏᴍᴍᴀɴᴅs ✰", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(text="✰ ᴍʏ ɪɴғᴏ ✰", callback_data="mukesh_"),
        InlineKeyboardButton(text="✰ ᴏᴜʀ ɴᴇᴛᴡᴏʀᴋ ✰", url=f"https://t.me/Alpha_X_supports"),
    ],
    [
...
➲ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴏғ ᴅᴏʀᴀ ʀᴏʙᴏᴛ ɪs ʜᴇʀᴇ sɪᴍᴘʟʏ ᴄʟɪᴄᴋ ᴀɴᴅ sᴇᴇ
  ‣ ɪɴ ᴘᴍ : ᴡɪʟʟ ꜱᴇɴᴅ ʏᴏᴜ ʜᴇʟᴘ​ ꜰᴏʀ ᴀʟʟ ꜱᴜᴘᴘᴏʀᴛᴇᴅ ᴍᴏᴅᴜʟᴇꜱ.
  ‣ ɪɴ ɢʀᴏᴜᴘ : ᴡɪʟʟ ʀᴇᴅɪʀᴇᴄᴛ ʏᴏᴜ ᴛᴏ ᴘᴍ, ᴡɪᴛʜ ᴀʟʟ ᴛʜᴀᴛ ʜᴇʟᴘ​ ᴍᴏᴅᴜʟᴇꜱ. 
  ➪ ᴅᴏʀᴀ ᴏᴡɴᴇᴅ ᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ [DJ](https://t.me/The_Alpha_X_help) . """

DONATE_STRING = """ʜᴇʏ ʙᴀʙʏ,
  ʜᴀᴩᴩʏ ᴛᴏ ʜᴇᴀʀ ᴛʜᴀᴛ ʏᴏᴜ ᴡᴀɴɴᴀ ᴅᴏɴᴀᴛᴇ.

ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴅᴇᴠᴇʟᴏᴩᴇʀ](https://t.me/Alpha_X_supports) ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ [sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ](https://t.me/NOOBCREATOR) ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_text(
            ...
            "\n➲  ʙᴏᴛ ᴏᴡɴᴇᴅ ᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ➪ [DJ](https://t.me/Alpha_X_supports) ."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="✰ ᴜᴩᴅᴀᴛᴇs ✰", url=f"https://t.me/The_Alpha_X_help"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="✰ ᴅᴇᴠᴇʟᴏᴩᴇʀ ✰", url="https://t.me/The_Alpha_X_help"
                        ),
                        InlineKeyboardButton(
                            text="✰ ɢɪᴛʜᴜʙ ✰", url="https://t.me/The_Alpha_X_help"
                        ),
                    ],
                    [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5662659781 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏʀᴄᴇ ᴄᴏᴅᴇ ɪs [PIROKID](https://t.me/vivekevil)."
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://te.legra.ph/file/11dc2653bc2d22ff1ebf9.mp4",
                caption=f"""
...
ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [❥︎❥︎𝐼𝑇𝑆𝑀𝐸ت︎𝑽𝑰𝑽𝑬𝑲 亗](https://t.me/{OWNER_USERNAME})🥀""",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
